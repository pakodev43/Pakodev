            ...
            <div className='px-5 md:px-25 flex flex-col gap-30 md:gap-40 max-w-[105rem] mx-auto'>
                ...
                <div className="md:grid grid-cols-2 gap-15 xl:gap-5 items-center">
                    ...
                    <div>
                        ...
                        <p className="mb-7 text-3xl md:text-4xl font-secondary font-bold">Abode - Real Estate</p>
                        <p className="text-lg text-accent-300 mb-7">Buy or sell homes, land, commercial properties, or any type of real estate.</p>
                        <div className='flex gap-5'>
                            <a href="https://aboderealestate.vercel.app/" target='_blank' className='flex items-center gap-3 bg-primary text-white border-2 hover:border-primary py-3 px-5.5 rounded-xl font-medium'>Visit <svg width="17" height="17" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.8335 9.16671L17.6668 2.33337" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M18.3335 5.66663V1.66663H14.3335" stroke="#F4F4F5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9.1665 1.66663H7.49984C3.33317 1.66663 1.6665 3.33329 1.6665 7.49996V12.5C1.6665 16.6666 3.33317 18.3333 7.49984 18.3333H12.4998C16.6665 18.3333 18.3332 16.6666 18.3332 12.5V10.8333" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></a>
                            <a href="https://github.com/pakodev43/Abode" target='_blank' className='flex items-center gap-3 bg-primary text-white border-2 hover:border-primary py-3 px-5.5 rounded-xl font-medium'>See Code <svg width="17" height="17" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.8335 9.16671L17.6668 2.33337" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M18.3335 5.66663V1.66663H14.3335" stroke="#F4F4F5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9.1665 1.66663H7.49984C3.33317 1.66663 1.6665 3.33329 1.6665 7.49996V12.5C1.6665 16.6666 3.33317 18.3333 7.49984 18.3333H12.4998C16.6665 18.3333 18.3332 16.6666 18.3332 12.5V10.8333" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="md:grid grid-cols-2 gap-15 xl:gap-5 items-center">
                    ...
                    <div>
                        ...
                        <p className="mb-7 text-3xl md:text-4xl font-secondary font-bold">Jacketers</p>
                        <p className="text-lg text-accent-300 mb-7">An E-commerce website for jackets business.</p>
                        <div className='flex gap-5'>
                            <a href="https://jacketers.vercel.app/" target='_blank' className='flex items-center gap-3 bg-primary text-white border-2 hover:border-primary py-3 px-5.5 rounded-xl font-medium'>Visit <svg width="17" height="17" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.8335 9.16671L17.6668 2.33337" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M18.3335 5.66663V1.66663H14.3335" stroke="#F4F4F5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9.1665 1.66663H7.49984C3.33317 1.66663 1.6665 3.33329 1.6665 7.49996V12.5C1.6665 16.6666 3.33317 18.3333 7.49984 18.3333H12.4998C16.6665 18.3333 18.3332 16.6666 18.3332 12.5V10.8333" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></a>
                            <a href="https://github.com/pakodev43/Jacketers" target='_blank' className='flex items-center gap-3 bg-primary text-white border-2 hover:border-primary py-3 px-5.5 rounded-xl font-medium'>See Code <svg width="17" height="17" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.8335 9.16671L17.6668 2.33337" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M18.3335 5.66663V1.66663H14.3335" stroke="#F4F4F5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9.1665 1.66663H7.49984C3.33317 1.66663 1.6665 3.33329 1.6665 7.49996V12.5C1.6665 16.6666 3.33317 18.3333 7.49984 18.3333H12.4998C16.6665 18.3333 18.3332 16.6666 18.3332 12.5V10.8333" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="md:grid grid-cols-2 gap-15 xl:gap-5 items-center">
                    <div className='mb-5 md:mb-0 md:max-w-xl'>
                        <img src={portfolioImage5} alt="" className='aspect-[3/2] rounded-2xl' />
                    </div>
                    <div>
                        <p className="mb-5 text-4xl md:text-5xl font-secondary font-semibold">05</p>
                ...
                <div className="md:grid grid-cols-2 gap-15 xl:gap-5 items-center">
                    <div className='mb-5 md:mb-0 md:max-w-xl ms-auto order-2'>
                        <img src={portfolioImage6} alt="" className='aspect-[3/2] rounded-2xl' />
                    </div>
                    <div>
                        <p className="mb-5 text-4xl md:text-5xl font-secondary font-semibold">06</p>
