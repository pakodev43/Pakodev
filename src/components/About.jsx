...
const About = () => {
  ...
  return (
    <div ref={containerRef} className='md:my-50 max-w-[105rem] mx-auto relative'>
      <div className='mx-2.5 md:mx-30'>
        <p className="ms-5 md:ms-35 text-4xl md:text-7xl font-tertiary uppercase">About</p>
      ...
      <div id="parallaxCard-10" className="absolute top-250 left-110 -rotate-5 h-30 md:h-50 aspect-[2/3] -z-10"><img src={ aboutSecParallaxImg10 } className="w-full h-full object-cover rounded-2xl" alt="Styling Image" /></div>
      <div id="parallaxCard-11" className="absolute top-200 left-350 rotate-5 h-30 md:h-50 aspect-[2/3] -z-10"><img src={ aboutSecParallaxImg11 } className="w-full h-full object-cover rounded-2xl" alt="Styling Image" /></div>
